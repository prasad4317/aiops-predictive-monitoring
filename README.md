...
![law-aiops-predictive — Overview](images/01-log-analytics-workspace.png)
...
![demo-rule — Data Collection Rule Overview](images/02-dcr-overview.png)
*demo-rule — Data Collection Rule Overview*

![demo-rule — Associated Resources (test-vm)](images/03-dcr-resources.png)
...
![evhns-aiops-predictive — Namespace Overview](images/04-eventhub-namespace.png)
*evhns-aiops-predictive — Namespace Overview*

![evhns-aiops-predictive — Event Hubs list](images/05-eventhub-list.png)
*evhns-aiops-predictive — Event Hubs list*

![eh-infra-telemetry — Event Hub Instance Overview](images/06-eventhub-instance.png)
...
![samplestorage232 — Diagnostic Settings](images/07-storage-diagnostic-settings.png)
*samplestorage232 — Diagnostic Settings*

![cost-detective-api — Diagnostic Settings](images/08-appservice-diagnostic-settings.png)
...
![my-workspace — Azure Machine Learning Workspace Overview](images/09-ml-workspace-overview.png)
...
![Model List — appjob12, storagetrainer09, trainingaiops19](images/10-model-list.png)
*Model List — appjob12, storagetrainer09, trainingaiops19*

![app-job — Automated ML job (Completed) — App Service model](images/11-app-job-completed.png)
*app-job — Automated ML job (Completed) — App Service model*

![storage-trainer01 — Automated ML job (Completed) — Storage model](images/12-storage-trainer-completed.png)
*storage-trainer01 — Automated ML job (Completed) — Storage model*

![training-aiops — Automated ML job (Canceled after sufficient trials completed) — VM model](images/13-vm-training-canceled.png)
*training-aiops — Automated ML job (Canceled after sufficient trials completed) — VM model*

![appjob12:1 — Registered App Service model details](images/14-appjob12-model-details.png)
*appjob12:1 — Registered App Service model details*

![storagetrainer09:1 — Registered Storage model details](images/15-storagetrainer09-model-details.png)
*storagetrainer09:1 — Registered Storage model details*

![trainingaiops19:1 — Registered VM model details](images/16-trainingaiops19-model-details.png)
...
![Endpoints — three real-time endpoints deployed](images/17-endpoints-list.png)
*Endpoints — three real-time endpoints deployed*

![my-workspace-app — App Service model endpoint (Healthy, 100% traffic)](images/18-app-endpoint.png)
*my-workspace-app — App Service model endpoint (Healthy, 100% traffic)*

![my-workspace-storageac — Storage model endpoint (Healthy, 100% traffic)](images/19-storage-endpoint.png)
*my-workspace-storageac — Storage model endpoint (Healthy, 100% traffic)*

![my-workspace-pfxkt — VM model endpoint (Healthy, 100% traffic)](images/20-vm-endpoint.png)
...
![func-aiops-bridge — Function App Overview](images/21-function-app-overview.png)
*func-aiops-bridge — Function App Overview*

![ProcessTelemetry — Function code (Code + Test)](images/22-function-code.png)
...
![aiops-ac — Automation Account Overview](images/23-automation-account-overview.png)
*aiops-ac — Automation Account Overview*

![aiops-ac — Runbooks (test-runbook, Published)](images/24-runbooks-list.png)
...
![aiops-pred — Teams channel (aiops-pred1)](images/25-teams-channel.png)
*aiops-pred — Teams channel (aiops-pred1)*

![Configured Workflows — App Alert, Storage Alert, and Remediation Status webhooks](images/26-teams-workflows.png)
...
![Function App Invocation log — real SCORED events, correctly classified as NORMAL](images/27-invocation-log-normal.png)
*Function App Invocation log — real SCORED events, correctly classified as NORMAL*

![Corresponding Teams card — "Storage Within Normal Range"](images/28-teams-normal-card.png)
